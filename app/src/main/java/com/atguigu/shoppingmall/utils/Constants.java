...
//    public static final String BASE = "http://192.168.51.104:8080";
    //系统默认的模拟器就用这个ip
    public static final String BASE = "http://192.168.1.32:8080";
    //使用第三方模拟器--当前电脑的ip地址
//    public static final String BASE = "http://192.168.51.104:8080";
    //运行到自己的真实手机上：
...
//    public static final String BASE = "http://192.168.191.1:8080";
    ...
    // 请求Json数据基本URL
    public static final String BASE_URL_JSON = BASE+"/ShoppingMall/json/";

    // 请求图片基本URL
    public static final String BASE_URl_IMAGE = BASE+"/ShoppingMall/img";
